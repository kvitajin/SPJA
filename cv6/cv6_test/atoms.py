...
class ExampleWorld(object):
    ...
    def random_atom(self):
        return FallDownAtom(random.randint(1,100), random.randint(1,100), random.randint(5,20), random.randint(5,20), random.randint(1,20), playground.Colors.BLUE.value)
...
if __name__ == '__main__':
    ...
    world = ExampleWorld(5, size_x, size_y)
